      ...
      <footer className="z-10 w-full max-w-2xl pb-6">
        <form onSubmit={handleSubmit} className="flex gap-2 w-full">
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 disabled:opacity-50 text-white font-bold px-6 py-3 rounded-xl text-sm transition-all uppercase tracking-wider"
          >
            Enviar
          </button>
        </form>
